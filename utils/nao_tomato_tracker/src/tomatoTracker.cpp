...
void TomatoTracker::track(Mat frame, Point2f &obj_pos, float &radius)
{
	Mat imgHSV;
	...
	trackObject(imgThresh, obj_pos, radius);
}
...
void TomatoTracker::trackObject(Mat imgThresh, Point2f &obj_pos, float &radius)
